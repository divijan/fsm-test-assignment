...
class TransitionController @Inject()(repo: EntitiesRepository,
   ...
   */
  val personForm: Form[CreateTransitionForm] = Form {
    mapping(
      "name" -> nonEmptyText,
      "age" -> number.verifying(min(0), max(140))
    )(CreateTransitionForm.apply)(CreateTransitionForm.unapply)
  }
   ...
   *
   * This is asynchronous, since we're invoking the asynchronous methods on TransitionRepository.
   */
 ...
 */
case class CreateTransitionForm(name: String, age: Int)
